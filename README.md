...
Note, there are closed regions which do not possess exit. If the mover pops there and follows the qtable, it will move there forever, i.e. will get "arrested". Just to avoid the arrest, the episode is cancelled after maximal reasonable number of moves. In this case $20\times 20=400$.
